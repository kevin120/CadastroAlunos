...
//
//        TextInputEditText edDescicaoDisciplina;
...
//            super(itemView);
////            edDescicaoDisciplina = (TextInputEditText) itemView.findViewById(R.id.edDescicaoDisciplina);
...
//
//        holder.edDescicaoDisciplina.setText(String.valueOf(disciplina.getDescricao()));
//        holder.edDuracaoDisciplina.setText(String.valueOf(disciplina.getDuracao()));
//        //holder.edProfessorDisciplina.setText(String.valueOf(disciplina.get));
//    }
//
//    @Override
